...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/home.html?bust=v0.5.4',
    '<div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/core/abstract.html?bust=v0.5.4',
    '<div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/core/empty.html?bust=v0.5.4',
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/home/hideRightPanel.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/home/home.html?bust=v0.5.4',
    '<panel heading="{{ \'SEARCH\' | translate }}"><div ng-include="\'js/modules/search/widget/search.html\'"></div></panel><panel heading="{{ \'RECENTLY_ADDED\' | translate }}"><div class="panel-body width-100 scroll-x"><table><tr><td class="valign-top" ng-repeat="video in recentVideos"><tile-video tile-class="width-xl margin-right-xs" video="video" details="true"></tile-video></td></tr></table></div></panel><div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/menu/menu.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/module.html?bust=v0.5.4',
    '<div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/user/home.html?bust=v0.5.4',
    '<div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/module.html?bust=v0.5.4',
    '<div ui-view=""></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/files/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/jobs/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/library/list.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/maintenance/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/module/detail.html?bust=v0.5.4',
    '');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/module/list.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/setting/edit.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/setting/list.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/tunnel/list.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/user/create.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/user/edit.html?bust=v0.5.4',
    '<div class="modal-header"><h3 class="modal-title">{{ \'ADMIN_SETTING_EDIT_TITLE\' | translate }}</h3></div><div class="modal-body"><div class="form-group"><label for="value">{{setting.groupKey}}/{{setting.key}}</label><input type="text" class="form-control" id="value" placeholder="Enter value" ng-model="setting.value"></div></div><div class="modal-footer"><button class="btn btn-primary" ng-click="ok()">{{ \'ADMIN_SETTING_EDIT_SAVE\' | translate }}</button><button class="btn btn-warning" ng-click="cancel()">{{ \'ADMIN_SETTING_EDIT_CANCEL\' | translate }}</button></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/admin/user/list.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/files/directory/detail.html?bust=v0.5.4',
    '<div class="col-md-{{$root.viewSize(8, 2)}} col-md-offset-{{$root.viewSize(2, -2, 0)}} column"><panel ng-show="directory" ng-cloak=""><panel-heading><h1>{{directory.path}}</h1></panel-heading><div class="row clearfix"><table class="table table-striped"><thead><tr></tr></thead><tbody><tr><td><a ui-sref="mediamine.files.directory({id: directory.parentDirectory.id})">..</a></td></tr><tr ng-repeat="d in directories"><td><a ui-sref="mediamine.files.directory({id: d.id})">{{d.name}}</a></td></tr><tr ng-repeat="f in files"><td ng-if="f.type != \'video\'">{{f.name}}</td><td ng-if="f.type == \'video\'">{{f.name}} <a ng-click="clickVideo(f.id)"><span class="glyphicon glyphicon-film"></span></a> <a ng-click="clickVideoPlay(f.id)"><span class="glyphicon glyphicon-play"></span></a></td></tr></tbody></table></div></panel></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/player/player/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/player/player/resume.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/player/playlist/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/main/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/person/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/series/index.html?bust=v0.5.4',
    '<panel heading="{{ \'SEARCH\' | translate }} {{ \'SERIES\' | translate }}"><div ng-include="\'js/modules/search/widget/search.html\'"></div></panel><div ng-switch="" on="videos.length"><div ng-switch-when="0"></div><div ng-switch-default=""><div class="h100 oScrollY"><div class="col-xs-{{$root.viewSize(2, 2)}} col-sm-{{$root.viewSize(2, 2)}} col-md-2 mbm" ng-repeat="serie in series"><tile image="{{serie.images[0].pathKey | imagePath : 300 : 400 : \'jpg\' : \'hrbox\' : \'placeholder\': \'hrbox_ffffff\'}}" title="{{serie.name}}" index="$index"><h4 class="space-nowrap overflow-hidden"><a ui-sref="mediamine.videolib.serie({id: serie.id})">{{serie.name}}</a></h4></tile></div></div></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/video/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/widget/menu-search.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/search/widget/search.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/ui/list-videos/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/ui/panel/panel.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/ui/tile/tile.html?bust=v0.5.4',
    '<div class="{{tileClass}} thumbnail fade"><div class="height-{{imageHeight}} overflow-hidden text-center"><span ng-if="withLink"><a ui-sref="{{imageLink}}"><img class="width-100" ng-src="{{image}}" alt="{{title}}"></a></span> <span ng-if="!withLink"><img class="width-100" ng-src="{{image}}" alt="{{title}}"></span></div><div class="caption" ng-transclude=""></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/ui/tile-carousel/index.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/ui/tile-video/index.html?bust=v0.5.4',
    '<div class="{{tileClass}}"><tile image="{{video.images[0].pathKey | imagePath : 300 : 400 : \'jpg\' : \'hrbox\' : \'video\': \'hrbox_ffffff\'}}" title="{{video.name}}" index="$index" image-link="{{imageLink}}"><div class="btn-group btn-group-xs tile-control"><a class="btn btn-xs btn-primary" ng-click="$root.$emit(\'playlist.play\', video)"><span class="glyphicon glyphicon-play"></span></a> <a class="btn btn-xs btn-primary" ng-click="$root.$emit(\'playlist.add\', video)"><span class="glyphicon glyphicon-plus"></span></a></div><h6 class="space-nowrap overflow-hidden"><span ng-if="details"><span ng-if="video.group"><a ui-sref="mediamine.videolib.serie({id: video.group.id})">{{video.group.name}}</a></span></span></h6><h4 class="space-nowrap overflow-hidden"><span ng-if="video.season"><a ui-sref="mediamine.videolib.season({id: video.season.id})">S{{video.season.number}}</a> -</span> <span ng-if="video.episode">{{video.episode}} -</span> <a ui-sref="mediamine.videolib.video({id: video.id})">{{video.name}}</a> <span ng-if="video.year">({{video.year}})</span></h4></tile></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/user/config/edit.html?bust=v0.5.4',
    '<div class="modal-header"><h3 class="modal-title">{{ \'ADMIN_SETTING_EDIT_TITLE\' | translate }}</h3></div><div class="modal-body"><div class="form-group"><label for="value">{{setting.groupKey}}/{{setting.key}}</label><input type="text" class="form-control" id="value" placeholder="Enter value" ng-model="setting.value"></div></div><div class="modal-footer"><button class="btn btn-primary" ng-click="ok()">{{ \'ADMIN_SETTING_EDIT_SAVE\' | translate }}</button><button class="btn btn-warning" ng-click="cancel()">{{ \'ADMIN_SETTING_EDIT_CANCEL\' | translate }}</button></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/user/config/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/user/logout/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/user/profile/main.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/filters/index.html?bust=v0.5.4',
    '<accordion close-others="{{false}}"><accordion-group heading="{{ \'RESULT\' | translate }} ({{ pagination.count }})"><pagination total-items="pagination.count" items-per-page="pagination.limit" ng-model="pagination.page" max-size="pagination.maxSize" class="pagination-sm" direction-links="false" boundary-links="true" rotate="false" previous-text="&lsaquo;" next-text="&rsaquo;" first-text="&laquo;" last-text="&raquo;"></pagination></accordion-group><accordion-group heading="{{ \'FILTER_TYPE\' | translate }}"><span ng-repeat="type in types track by $index"><span class="btn btn-primary btn-sm margin-bottom-xxs" ng-click="selectType(type)">{{type.name}}</span>{{$last ? \'\' : \' \'}}</span><div class="clearfix"><a class="pull-right" ng-click="resetType()">{{ \'RESET\' | translate }}</a></div></accordion-group><accordion-group heading="{{ \'FILTER_GENRE\' | translate }}"><span ng-repeat="genre in genres"><span class="btn btn-primary btn-sm margin-bottom-xxs" ng-click="selectGenre(genre)">{{genre.name}}</span>{{$last ? \'\' : \' \'}}</span><div class="clearfix"><a class="pull-right" ng-click="resetGenre()">{{ \'RESET\' | translate }}</a></div></accordion-group><accordion-group heading="{{ \'FILTER_YEAR\' | translate }}"><p><span>{{sliderYear[0]}}</span><span class="pull-right">{{sliderYear[1]}}</span></p><slider ng-model="sliderYear" tooltip="hide" range="slider.range" min="slider.min" step="slider.step" max="slider.max" value="slider.value"></slider><div class="clearfix pull-right"><a class="btn btn-primary btn-xs" ng-click="filterYear(sliderYear)">{{ \'OK\' | translate }}</a> <a ng-click="resetYear()">{{ \'RESET\' | translate }}</a></div></accordion-group><accordion-group heading="{{ \'FILTER_RATING\' | translate }}"></accordion-group><accordion-group heading="{{ \'FILTER_LIBRARY\' | translate }}"></accordion-group><accordion-group heading="{{ \'FILTER_VIEWED\' | translate }}"></accordion-group></accordion>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/person/detail.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/season/detail.html?bust=v0.5.4',
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/series/list.html?bust=v0.5.4',
    '<div class="col-xs-{{$root.viewSize(2, 2)}} col-sm-{{$root.viewSize(2, 2)}} col-md-2 mbm" ng-repeat="serie in series"><tile image="{{serie.images[0].pathKey | imagePath : 300 : 400 : \'jpg\' : \'hrbox\' : \'placeholder\': \'hrbox_ffffff\'}}" title="{{serie.name}}" index="$index" image-link="mediamine.videolib.serie({id: {{serie.id}}})"><h4 class="space-nowrap overflow-hidden"><a ui-sref="mediamine.videolib.serie({id: serie.id})">{{serie.name}}</a></h4></tile></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('js/modules/video-library/video/list.html?bust=v0.5.4',
