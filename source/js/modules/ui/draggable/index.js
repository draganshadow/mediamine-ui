            ...
            return {
                ...
                link: function (scope, element, attrs) {
                  ...
                  //  return;
                    ...
                    var w, h;
                    var resize = attrs.ngDragResize ? parseInt(attrs.ngDragResize, 10) : 1;
                    ...
                    var onlongpress = function(evt) {
                        ...
                        w = element.width() / resize;
                        h = element.height() / resize;
                        element.centerX = (w/2);
                        element.centerY = (h/2);
                    ...
                    var reset = function() {
                        element.css({left:'',top:'', position:'', 'z-index':'', width: '', height: ''});
                    };

                    var moveElement = function(x,y) {
                        element.css({left:x,top:y, width: w + 'px', height: h + 'px', position:'fixed', 'z-index':99999});
                    };
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var absorbEvent_ = function (event) {
                        ...
                        var t = e.preventDefault && e.preventDefault();
