        ...
        Restangular.one('video', $routeParams.id).get()
            .then(function(result) {
                ...
                projekktor('#player_a', {
                        ...
                        playerFlashMP4: './js/vendor/projekktor/swf/StrobeMediaPlayback/StrobeMediaPlayback.swf',
                        playerFlashMP3: './js/vendor/projekktor/swf/swf/StrobeMediaPlayback/StrobeMediaPlayback.swf',
                        width: 640,
                        height: 385,
